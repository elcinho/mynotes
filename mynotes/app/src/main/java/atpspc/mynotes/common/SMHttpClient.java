...
/**
 * Created by creatorbh on 11/8/14.
 */
public class SMHttpClient extends DefaultHttpClient
{
    ...
    public SMHttpClient(Context context, ClientConnectionManager clientConnectionManager, HttpParams httpParams)
    {
